...
public class HistoryCardAdapter extends RecyclerView.Adapter<HistoryCardAdapter.ViewHolder> {
    ...
    public HistoryCardAdapter(List<HistoryData> historyData, Context context) {
    ...
    @Override
    public HistoryCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(HistoryCardAdapter.ViewHolder holder, int position) {
